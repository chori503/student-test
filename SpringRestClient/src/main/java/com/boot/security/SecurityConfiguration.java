...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	/*creo el bean de authentication manager para autentificar las peticiones http por medio de usaurio y password 
	 * aun que tambien se requiere autorizacion de la client Api 
	 */
	@Bean
