...
@Service
public class UserDetailsConfiguraciones implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		UserDetails useDetails = new User(us.getUser(), us.getPass(), us.getState(), us.getState(), us.getState(),
				us.getState(), roles);
		return useDetails;
	}
}
